...
{ 
document.write('<link rel="stylesheet" href="../common/styles/stylesheet.css" type="text/css">');
}
else {
document.write('<link rel="stylesheet" href="../common/styles/stylesheet_ns.css" type="text/css">');
}
...
<body>
<div class="wrapper">
  <div class="logobkg"><img src="../common/images/logo_new.png" alt="logo"/></div>
  <div class="navbar">
    <div class="buttons">
    <%
